...
export const usePortfolioStore = defineStore('portfolioStore', {
  state: () => ({
    ...
    headers: [
      ...
      { title: 'Değişim TL', key: 'dailyChangeInTL', align: 'end' },
      { title: 'Ort. Maliyet', key: 'averageCost', align: 'end' },
      { title: '% Kar/Zarar', key: 'profitLossPct', align: 'end' },
      { title: 'Kar/Zarar TL', key: 'profitLossInTL', align: 'end' },
